...
export const appReducer = createReducer(
  ...
  on(appActions.fetchCurrentTitleSuccess, (state, { currentTitle }) => {
    ...
    const isCheckAddedToWatchList = state.watchList.find(movie => movie.imdbID === currentTitle.imdbID);
  ...
  on(appActions.loadSuggestionsFailure, (state) => ({ ...state, suggestions: [] })), // edit later
  on(appActions.clearSuggestions, (state) => ({ ...state, suggestions: [] })),
